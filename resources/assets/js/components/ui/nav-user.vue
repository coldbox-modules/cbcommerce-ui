<template>
    <div>
        ...
        <ul class="list-unstyled account-menu-item" >
        	<li v-if="authUser"><a href="/store/wishlists"><i class="fa fa-heart-o"></i>&nbsp; {{$t("Wishlists")}}</a></li>
            ...
            <li><a href="/store/product/comparison" v-tooltip="'Comparisons'"><i class="fa fa-random"></i> {{ $t( "Compare" ) }}</a></li>
